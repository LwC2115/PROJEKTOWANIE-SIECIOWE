      ...
      onEachFeature: function (feature, layer) {
        layer.on('click', function () {
          ...
          if (clickedCountry === currentCountry){
            score++;
            document.getElementById(`result1`).innerText ="Poprawna odpowiedź!";
            document.getElementById('result1').style.color = 'green';
            document.getElementById('points1').innerText =`Punkty: ${score}`;            
            highlightCountry(layer, true)

            if (score === countriesList.length) {
              document.getElementById('country-name1').innerText = `Gratulacje! Zaznaczyłeś wszystkie kraje!!`;
            ...
            document.getElementById('result1').innerText =`Błędna odpowiedź, zaznaczyłeś ${clickedCountry}!!`;
